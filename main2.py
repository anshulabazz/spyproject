from spy_details2 import spy,Spy,ChatMessage,friends,maintain
...
def add_friend():
 ...
 spy.name=input("enter your friend name:")
 while spy.name.isalpha()!= False:

     spy.salutation =input("what you prefer for your friend \"Mr or Ms. \" :")
     value = True
     while value :
         if spy.salutation == 'mr' or spy.salutation =='Mr' or spy.salutation == 'MR' or spy.salutation == 'MS' :
            value =False
         else :
             spy.salutation =input("Please enter the valid salutation \"Mr or Ms. \": ")

     spy.salutation = 'M' +spy.salutation [1:]
     while len(spy.name) <= 0:
         spy.name= input("pleae enter valid name")
     ...
     if confirmAge.upper() !='Y':
         ...
         spy.age = int(input("enter your friend age: "))
         while spy.age > 50 or spy.age < 12 :
             spy.age = int(input("Incorrect Age .please enter again"))

         spy.rating =float(input("enter your friend rating: "))
     while spy.rating < 0 or spy.rating > 5:
         spy.rating = float(input("incorrect rating .please enter again : "))
...
def select_a_friend() :
        ...
        select  = int(input("select a  friend:"))
        while select > totalfriends or select <=0 :
            select =int(input("No name exist in  this position in your friend list. please enter again :"))
...
def send_a_secret_message():
   ...
   # receiver = select
    original_image= input("Please enter the name of the image:")
    original_image = original_image
    new_img = input("new name of the image:")
    new_img = str(new_img)

    text = input("enter the message you want to send to your friend:")
